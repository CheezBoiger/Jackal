...
TEST(MathTesting, MatrixTesting) {
  ...
  jackal::Mat4f C = B;
  C = C.Inverse();
  jackal::Quat q0(1.0f, 0.0f, 0.0f, 2.0f);
  jackal::Quat q1(3.0f, -1.0f, 4.0f, 3.0f);
  jackal::Quat ans = q0 * q1;
  ans = ans.Inverse();
  ...
  jackal::Vec4f vec(1.0f, 0.0f, 0.0f, 1.0f);
  jackal::Vec3f a(1.0f, 2.0f, 3.0f);
  jackal::Vec3f b(4.0f, 5.0f, 6.0f);
  //a *= b;
  std::printf("Vector values: x=%f y=%f z=%f w=%f\n", vec.r, vec.g, vec.b, vec.a);
  jackal::Vec3f c = Cross(a, b);
  bool yup = A == B;
